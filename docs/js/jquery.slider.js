    ...
    $.fn.slider = function(options) {
        ...
        var _close = function() {
            ...
            if (settings.showControls) {
                var controlPrev = $('<span class="jquery-slider-control jquery-slider-control-prev"><img src="../images/nc/nc_arrow_left.png" width="48"></span>').bind('click', function() {_prev();});
                var controlNext = $('<span class="jquery-slider-control jquery-slider-control-next"><img src="../images/nc/nc_arrow_right.png" width="48"></span>').bind('click', function() {_next();});
                var controlClose = $('<span class="jquery-slider-control jquery-slider-control-close"><img src="../images/nc/nc_btn_close.png" width="48"></span>').bind('click', function() {_close();});
                $this.append(controlPrev);
                $this.append(controlNext);
                $this.append(controlClose);
            }
